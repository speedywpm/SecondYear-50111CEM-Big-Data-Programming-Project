function [RunTime]=SequentialProcessing(Parameter, FileName, DataLayer)
...
for NumHour = 1: IncrementsProcessed % loop through each hour
    ...
    t1 = toc;
    t2 = t1;
    for idx = Parameter: Segments % size(Data2Process,1) step through each data location to process the data
