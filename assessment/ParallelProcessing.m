...
Num2Process = 1000; %HERE IS NUMBER OF DATA TO PROCESS OF EACH HR
Steps = 100;
tic
...
%     % 'DataQ'. See end of script for the function definition.
    ...
    %WAITBAR COMMENTED FEW LINES ABOVE
    ...
    T4 = toc;
    ParFor=5000;
    parfor idx = DataParameter: ParFor  %Num2Process % size(Data2Process,1)
    ...
    %close(hWaitBar); % close the wait bar PART OF WAITBAR
